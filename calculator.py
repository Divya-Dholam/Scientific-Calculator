...
btnClear = Button(calc, text='C',width=6,height=2,bg='powder blue',font=('Helvetica',20,'bold'),
                  bd=4, command=added_value.Clear_Entry).grid(row=1, column=0, pady=1)

btnAllClear = Button(calc, text='CE',width=6,height=2,bg='powder blue',font=('Helvetica',20,'bold'),
...
btnlog1p = Button(calc, text='log1p',width=6,height=2,bg='black',fg='white',font=('Helvetica',20,'bold'),
